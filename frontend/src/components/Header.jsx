              ...
              <>
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 text-gray-700 hover:text-red-600 font-medium transition-colors duration-200 px-3 py-2 rounded-lg hover:bg-red-50"
                  >
                ...
                {user && (
                  <div className="hidden md:block text-right">
                    ...
                    <p className="text-xs text-gray-500">Points: {user.points || 0}</p>
                  </div>
                )}
              </>
            ) : (
